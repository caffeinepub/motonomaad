          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h1 className="font-display text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-normal tracking-tight leading-[0.9] text-balance">
                  <span className="block">RIDE</span>
                  <span className="block text-primary" style={{ WebkitTextStroke: '2px currentColor', WebkitTextFillColor: 'transparent' }}>FREE.</span>
                  <span className="block">RIDE FAR.</span>
                </h1>
                <p className="text-lg md:text-xl text-muted-foreground text-balance max-w-xl">
            ...
            {steps.map((step, index) => (
              <div key={index} className="relative">
                <div className="space-y-4">
                  <div className="text-6xl font-heading text-primary/20">{step.number}</div>
